    ...
    public function run()
    {
        ...
        foreach ($properties as $propertyData) {
            ...
            $newPro = [
                ...
                'electrical_value'=> array_key_exists('electricalValue', $propertyData) ? $propertyData['electricalValue'] : NULL,
                ...
                'floor_load'=> array_key_exists('floorLoad', $propertyData) ? $propertyData['floorLoad'] : NULL,
                ...
                'land_size'=> array_key_exists('landSize', $propertyData) ? $propertyData['landSize'] : NULL,
                ...
                'no_of_cargo_lift'=> array_key_exists('noOfCargoLift', $propertyData) ? $propertyData['noOfCargoLift'] : NULL,
                'no_of_storey'=> array_key_exists('noOfStorey', $propertyData) ? $propertyData['noOfStorey'] : NULL,
                ...
                'price'=> array_key_exists('price', $propertyData) ? $propertyData['price'] : NULL,
                ...
                'top_year'=> array_key_exists('topYear', $propertyData) ? $propertyData['topYear'] : NULL,
                'swimming_pool'=> array_key_exists('swimmingPool', $propertyData) ? $propertyData['swimmingPool'] : NULL,
                'tenanted_price'=> array_key_exists('tenantedPrice', $propertyData) ? $propertyData['tenantedPrice'] : NULL,
                ...
                'valuation'=> array_key_exists('valuation', $propertyData) ? $propertyData['valuation'] : NULL,
